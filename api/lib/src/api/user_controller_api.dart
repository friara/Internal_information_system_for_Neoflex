...
class UserControllerApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserExtendedDTO>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserExtendedDTO>>> adminGetAllUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<UserExtendedDTO>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(UserExtendedDTO)]),
      ) as BuiltList<UserExtendedDTO>;
    ...
    return Response<BuiltList<UserExtendedDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserExtendedDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserExtendedDTO>> adminGetUser({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/users/{id}/full'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UserExtendedDTO? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserExtendedDTO),
      ) as UserExtendedDTO;
    ...
    return Response<UserExtendedDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UserDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDTO>> adminUploadAvatar({ 
    required int id,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserDTO>>> getAllUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> saveFcmToken({ 
    ...
    final _path = r'/api/users/fcm-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [UserDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDTO>> uploadAvatar({ 
    required MultipartFile file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
