...
class ChatControllerApi {
  ...
  const ChatControllerApi(this._dio, this._serializers);
  ...
  Future<Response<ChatDTO>> createChat({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChatDTO),
      ) as ChatDTO;
  ...
  Future<Response<void>> deleteChat({ 
    ...
    final _path = r'/api/chats/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ChatDTO>>> getAllChats({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ChatDTO)]),
  ...
  /// Returns a [Future] containing a [Response] with a [ChatDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatDTO>> getChatById({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
