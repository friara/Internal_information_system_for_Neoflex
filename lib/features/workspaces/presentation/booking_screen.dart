...
//             child: ListView.builder(
//               shrinkWrap: true,
//               itemCount: 24 * 60, // Количество минут в дне
//               itemBuilder: (BuildContext context, int index) {
//                 final hour = index ~/ 60;
//                 final minute = index % 60;
//                 final time = TimeOfDay(hour: hour, minute: minute);
...
//      await _repository.getAvailableWorkspaces(_selectedStart!, _selectedEnd!); 
//     }
//     else {_repository.refreshWorkspaces();}
...
//         start: const TimeOfDay(hour: 9, minute: 0),
//         end: const TimeOfDay(hour: 18, minute: 0),
//         //minStartTime: const TimeOfDay(hour: 9, minute: 0),
//         //maxEndTime: const TimeOfDay(hour: 18, minute: 0),
//         interval: const Duration(minutes: 15),
//         disabledTime: TimeRange(
//           startTime: const TimeOfDay(hour: 0, minute: 0),
//           endTime: const TimeOfDay(hour: 9, minute: 0),
